            ...
            <div class="details">
              <h3><?php the_title(); ?></h3>
				<?php if (! empty ($trainer_designation)): ?>
             	 <span><?php echo esc_html($trainer_designation); ?></span>
				<?php  endif; ?>
              <p><?php the_content(); ?></p>
              <ul>
                <li><p>Experience<span>:</span></p>
                	<?php if (! empty ($trainer_exprience)): ?>
                	<p><?php echo esc_html($trainer_exprience); ?></p>
                	<?php  endif; ?>
                </li>
                <li><p>Mobile<span>:</span></p>
					<?php if (! empty ($trainer_mobile)): ?>
                	<p><?php echo esc_html($trainer_mobile); ?></p>
					<?php endif; ?>
                </li>
                <li><p>Email<span>:</span></p>
                	<?php if (! empty ($trainer_email)): ?>
                	<p><?php echo esc_html($trainer_email); ?></p>
					<?php endif; ?>
                </li>
                <li>
              ...
              <div class="personal">
                ...
                <?php endif; ?>
                <ul>
                  <li><p>Duration<span>:</span></p><?php if (!empty($course_duration)) :?><p><?php echo esc_html($course_duration); ?></p><?php endif; ?></li>
                  <li><p>Course Fee<span>:</span></p><?php if (!empty($course_fee)) :?><p><?php echo esc_html($course_fee); ?></p><?php endif; ?></li>
                </ul>

                  <a href="<?php  esc_url($trainer_Contact); ?>" class="default-button">Contact Trainer</a>
              </div><!-- personal -->
            </div><!-- details -->
          </div>