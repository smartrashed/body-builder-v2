...
class Body_Builder_footer_Recent_Posts extends WP_Widget {

    public function __construct() {
		parent::__construct(
			'body_builder_recent_posts',	// Base ID
			esc_html__( 'Body Builder:: Footer Recent Posts', 'body-builder' ),	// Name
			...
			<li class="post-item">
							...
							if( ! empty( $instance['showimage'] ) ) :
								...
								if( has_post_thumbnail() ) : ?>
									...
									<div class="post-image"><a href="<?php esc_attr(the_permalink()); ?>"><?php esc_attr(the_post_thumbnail('body-builder-all-thumb')); ?></a></div>
...
register_widget('Body_Builder_footer_Recent_Posts');
