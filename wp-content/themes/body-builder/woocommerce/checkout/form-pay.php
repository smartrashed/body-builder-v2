...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php _e( 'Product', 'body-builder' ); ?></th>
				<th class="product-quantity"><?php _e( 'Qty', 'body-builder' ); ?></th>
				<th class="product-total"><?php _e( 'Totals', 'body-builder' ); ?></th>
			</tr>
		</thead>
		<tbody>
